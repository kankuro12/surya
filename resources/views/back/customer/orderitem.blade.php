                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{URL::to('/back/img/joborder/'.$image->path)}}"
                                        class="btn btn-primary btn-sm" target="_blank">View</a> ||
                                    <a href="{{ route('imagedownload',$image->id)}}"
                                        class="btn btn-primary btn-sm">Download</a> ||
                                    <a href="{{ route('imagedelete',$image->id)}}"
                ...
                <table id="bootstrap-table" class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ asset('back/img/design/') }}/{{$file->path}}"
                                    class="btn btn-primary btn-sm">Download</a> ||
...
<button type="button" class="btn btn-warning" data-toggle="modal" data-target="#imagedesigner">File Upload By
    Designer</button>
...
<!-- Modal -->
<div class="modal fade" id="imagedesigner" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form method="post" action="{{url('/design/order_items/'.$orderitems[0]->id)}}"
