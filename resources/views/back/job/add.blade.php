                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input onkeyup="searchCustomer(this.value)" name="c_phone" type="tel" placeholder="Enter customer pnone no." class="form-control" required id="c_phone">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="c_name" type="text" placeholder="Enter customer name" class="form-control" required id="c_name">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="c_address" type="text" placeholder="Enter customer address" class="form-control" required id="c_address">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="c_email" type="email" placeholder="Enter customer email" class="form-control" required id="c_email">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="order_received_date" type="text" id="nepali-date" placeholder="Received Date" class="form-control" required>
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input name="order_delever_date" id="nepali-calendar1"  type="text" placeholder="Delivery Date" class="form-control" required >
                                                    </div>
                                        ...
                                        <div id="orderitemadd">
                                            <div class="row">
                                                <div class="col-md-9">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input  type="text" placeholder="Received Date" class="form-control"  id="item_particular">
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                        ...
                                                        <div class="form-group">
                                                            <label>Type</label>
                                                            <select onchange="mediaTypeChange()" placeholder="Total" class="form-control"  id="item_type">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input  onkeyup="calculateSize(); calculateItemSize();"  type="number" placeholder="Height" class="form-control dis"   id="item_height" value="0">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input onkeyup="calculateSize(); calculateItemSize();"  type="number" placeholder="Height" class="form-control dis"  id="item_height_in" value="0">
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input onkeyup="calculateSize(); calculateItemSize();"  type="number" placeholder="Width" class="form-control dis"  id="item_width" value="0">
                                                 ...
                                                 <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input onkeyup="calculateSize(); calculateItemSize();"  type="number" placeholder="Width" class="form-control dis"  id="item_width_in" value="0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label>Qty</label>
                                                        <input onkeyup="calculateSize(); calculateItemSize();"  type="number" placeholder="Qty" class="form-control"  id="item_qty" value="1">
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Size</label>
                                                        <input onkeyup="calculateItemSize();" type="number" placeholder="Size" class="form-control dis"  id="item_size" value="0">
                                                    </div>
                                                </div>
                                                  ...
                                                  <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label>Rate</label>
                                                        <input onkeyup="calculateItemSize();"  type="number" placeholder="Rate" class="form-control"  id="item_rate" value="0">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="col-md-9">
                                                        <div class="form-group">
                                                            <label>Remarks</label>
                                                            <input type="text" name="remark" placeholder="Enter remarks" class="form-control" id="item_remarks">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <div class="form-group">
                                                        <label>  </label>
                                                        <input type="submit" class="form-control btn btn-primary" onclick="addItem();return false;" value="Add">
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    ...
                                                    <input  name="grand_total" type="number" placeholder="grand_total" class="form-control" required id="grandtotal" value="0">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input name="discount" onkeyup="calculateTotal()"  type="number" placeholder="discount" class="form-control" required id="discount" min="0" value="0">
                                                    </div>
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    <label>Paid</label>
                                                    <input name="advance" onkeyup="calculateTotal()"  type="number" placeholder="advance" class="form-control" required id="paid" value="0" min="0">
                                                </div>
                                            ...
                                            <div class="col-md-3">
                                                ...
                                                <div class="form-group">
                                                    <label>Due</label>
                                                    <input name="due" type="number" placeholder="Due" class="form-control" required id="due" value="0" min="0" >
                                                </div>
