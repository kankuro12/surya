                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="numbers">
                            ...
                            <h5 class="card-title"><span class="text-warning"
                                    style="font-size:11px; font-weight:bold;">Rs.</span> {{$salary}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-7">
                        <div class="numbers">
                            ...
                            <h5 class="card-title"><span class="text-success"
                                    style="font-size:11px; font-weight:bold;">Rs.</span> {{$exp}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-7">
                        <div class="numbers">
                            ...
                            <h5 class="card-title"><span class="text-primary"
                                    style="font-size:11px; font-weight:bold;">Rs.</span> {{$totalbill}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="numbers">
                            ...
                            <h5 class="card-title"><span class="text-success"
                                    style="font-size:11px; font-weight:bold;">Rs.</span> {{$due}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="numbers">
                            ...
                            <h5 class="card-title"><span class="text-danger"
                                    style="font-size:11px; font-weight:bold;">Total.</span> {{$staff}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="numbers">
                            ...
                            <h5 class="card-title"><span class="text-primary"
                                    style="font-size:11px; font-weight:bold;">Total.</span> {{$customer}}</h5>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="numbers">
                            ...
                            <h4 class="card-title"><span class="text-warning"
                                    style="font-size:11px; font-weight:bold;">Total.</span> {{$supplier}}</h4>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-7">
                        <div class="numbers">
                            ...
                            <h4 class="card-title"><span class="text-primary"
                                    style="font-size:11px; font-weight:bold;">Rs.</span> {{$totaladv}}</h4>
                        </div>
                    </div>
                </div>
            </div>
